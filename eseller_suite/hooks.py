...
doc_events = {
	'Sales Invoice':{
		...
		"on_trash": "eseller_suite.eseller_suite.custom_script.sales_invoice.sales_invoice.on_trash",
	},
	'Purchase Receipt':{
	...
	'Stock Entry':{
		...
		"on_cancel": "eseller_suite.eseller_suite.custom_script.stock_entry.stock_entry.on_cancel",
